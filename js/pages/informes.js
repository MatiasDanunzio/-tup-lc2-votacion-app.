import { obtenerInformesAlmacenados } from "../keyInformes.js";
import { obtenerProvinciaPorDistrito, mapasProvinciales } from "../mapas.js"
...
async function crearTabla(url, anio, tipoRecuento, tipoEleccion, categoriaId, distritoId, seccionProvinciaId, seccionId, circuitoId, mesaId,selectedCargo, selectedDistrito, selectedSeccion) {
    ...
    if (data2) {
        document.getElementById("mensajeNoInforme").style.display = "none";
        document.getElementById("sec-contenido").style.display = "block";
        ...
        provinciaCell.innerHTML = mostrarMapa(distritoId); 
...
function construirDatosPorAgrupacion(valoresTotalizadosPositivos) {
    ...
    valoresTotalizadosPositivos.forEach(agrupacion => {
        ...
        porcentajeListaElement.textContent = `${agrupacion.votosPorcentaje.toFixed(2)}%`;
